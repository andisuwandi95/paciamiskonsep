...
ob_start();
?>
	<nav class="u-dropdown-icon u-menu u-menu-dropdown u-offcanvas u-offcanvas-shift u-menu-1" data-responsive-from="XS">
      <div class="menu-collapse" style="font-size: 1rem; letter-spacing: 0; font-weight: 500;">
        <a class="u-active-grey-5 u-button-style u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-top-bottom-menu-spacing u-hover-grey-10 u-nav-link u-text-active-grey-90 u-text-grey-60 u-text-hover-grey-90" href="#">
...
$menu_html = buildMenu($list, $default_id, $active_id, $path, array(
		'container_class' => 'u-dropdown-icon u-menu u-menu-dropdown u-offcanvas u-offcanvas-shift u-menu-1',
		'menu_class' => 'u-nav u-unstyled u-nav-1',
		'item_class' => 'u-nav-item',
		'link_class' => 'u-active-grey-5 u-button-style u-hover-grey-10 u-nav-link u-text-active-grey-90 u-text-grey-60 u-text-hover-grey-90',
        'link_style' => 'padding: 10px 252px;',
		'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-b5d6-19',
...
$resp_menu = buildMenu($list, $default_id, $active_id, $path, array(
        ...
        'link_style' => '',
		'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-b5d6-17',
		'submenu_item_class' => 'u-nav-item',
		'submenu_link_class' => 'u-button-style u-nav-link u-white',
        'submenu_link_style' => ''
	)
